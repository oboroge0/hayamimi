...
/// ~640MB on disk (see `docs/design/mobile_quantization.md`'s routing note), well over a
...
/// `docs/design/mobile_quantization.md`.
enum RoutingProfile {
...
/// `docs/design/mobile_quantization.md` for why that's an acceptable simplification).
