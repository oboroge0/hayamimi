...
| 精度 turbo比 +0.5%以内 | ✅超過達成 — **日本語CER 5.8%はWhisper turbo(13.8%)の半分以下**（実放送音声・ビームサーチ）。全5主要言語を実音声で検証済み（docs/results/scorecard.md） |
...
日本語句読点・韓国語分かち書き・OBS配信・回帰テスト。全履歴は docs/results/benchmarks.md。
